...
This project facilitates the migration of Oracle PL/SQL packages to dbt models running on Snowflake. The structure is designed
to support coding assistants and maintain clear separation between different layers of data transformation.
